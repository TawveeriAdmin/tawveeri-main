/**
 * Saudi Riyal SVG symbol for React Native.
 * Matches the web SARSymbol from @/components/ui/price.
 */
...
export function SARSymbol({ size = 12, color = '#666' }: SARSymbolProps) {
  return (
    <Svg
    ...
    >
      <Path d={SAR_PATH_1} fill={color} />
      <Path d={SAR_PATH_2} fill={color} />
    </Svg>
  );
}
