...
**Overall: 76/100** · updated 2026-07-26 13:23 UTC · ▲ 0 vs last run · run `npm run tps:launch-audit`

| Area | Cur | Tgt | Gap | Trend | Prio | Cust | Biz | Evidence |
|---|---|---|---|---|---|---|---|---|
| Product Coverage | 91 | 90 | -1 | → | P2 | M | M | 4095 published products |
| Category Coverage | 77 | 90 | +13 | → | P1 | H | H | 20/26 categories have a comparison |
| Brand Coverage | 14 | 60 | +46 | → | P2 | M | M | 51/357 brands have a comparison |
| Comparison Coverage | 14 | 30 | +16 | → | P0 | H | H | 585/4095 products multi-store (21% of those are 3+ store) |
| Specification Coverage | 64 | 95 | +31 | → | P2 | M | L | 64% canonicals carry structured attributes |
| Image Coverage | 93 | 95 | +2 | → | P1 | H | M | 93% published products imaged (ADR-113) |
...
| Comparison Quality | 90 | 95 | +5 | → | P0 | H | H | corroboration-first ranking; 495 cards surface real savings (Σ≈248,926 SAR) |
...
| Performance | 98 | 90 | -8 | → | P1 | H | M | decide 935ms · search 482ms (warm median, incl. client RTT) |
...
_Overall trend: 69 → 71 → 71 → 74 → 75 → 76 → 76_
