...
**Overall: 74/100** · updated 2026-07-26 11:05 UTC · ▲ 3 vs last run · run `npm run tps:launch-audit`
...
| Performance | 96 | 90 | -6 | ↑76 | P1 | H | M | decide 1149ms · search 442ms (warm median, incl. client RTT) |
...
**P1 gaps:** Category Coverage, Canonical Accuracy, Security

_Overall trend: 69 → 71 → 71 → 74_
