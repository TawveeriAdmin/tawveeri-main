...
**Overall: 79/100** · updated 2026-08-02 19:53 UTC · ▲ 1 vs last run · run `npm run tps:launch-audit`
...
| Canonical Accuracy | 94 | 90 | -4 | ↑15 | P1 | H | M | 0 duplicate cards; comparable-product avg confidence 93; 0 sentinel leaks (gate) |
| Customer Trust | 85 | 90 | +5 | → | P1 | H | H | deterministic evidence-cited trust engine live; named corroboration + data age |
| Performance | 98 | 90 | -8 | → | P1 | H | M | decide 931ms · search 434ms (warm median, incl. client RTT) |
| Data Freshness | 100 | 95 | -5 | → | P1 | M | M | 10/10 DISPLAYABLE retailers fresh (<48h); retired retailers excluded by design |
| Crawler Stability | 96 | 95 | -1 | → | P1 | M | M | 430/446 runs succeeded in 48h; 3 store(s) with a failed run |
| Affiliate Readiness | 80 | 80 | 0 | → | P2 | L | H | 2 programs verified AGAINST THE PROGRAM (ADR-181): amazon tag=tawveeri-21, noon utm_source=C1000094L |
...
| Technical Debt | 75 | 85 | +10 | → | P2 | L | M | TS/ESLint errors ignored in build; noon/swsg repaired 2026-08-02 (ADR-179/180) (assessed) |

**P0 gaps:** Comparison Coverage

**P1 gaps:** Category Coverage, Image Coverage

_Overall trend: 69 → 71 → 71 → 74 → 75 → 76 → 76 → 73 → 78 → 79_
