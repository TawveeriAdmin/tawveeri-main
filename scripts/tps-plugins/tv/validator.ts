// scripts/tps-plugins/tv/validator.ts
// Confidence = completeness of identity-critical TV fields (brand, size,
// resolution, panel). A manufacturer model number is the strongest signal.
...
export function scoreConfidence(
  ...
  if (!payload.panel) missing.push("panel");
