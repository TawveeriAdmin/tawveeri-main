...
export type TpsCategory = 'mobile' | 'air_conditioner' | 'laptop' | 'tv' | 'tablet';
...
export function assertBatchInvariants(opts: TpsBatchOptions): void {
  if (opts.category !== 'mobile' && opts.category !== 'air_conditioner' && opts.category !== 'laptop' && opts.category !== 'tv' && opts.category !== 'tablet') {
