...
export function ExpenseForm({ initial, onDone }: { initial?: Record<string, any> | null; onDone?: () => void }) {
  ...
  return (
    <form onSubmit={submit} className="grid gap-3 sm:grid-cols-2">
      ...
      <Field label="بداية فترة الخدمة *" name="service_period_start" errors={errors}><input name="service_period_start" type="date" required defaultValue={initial?.service_period_start ?? today} className={inputCls} /></Field>
