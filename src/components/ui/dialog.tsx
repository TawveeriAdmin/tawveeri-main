  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'bg-[color:var(--color-surface)] p-6 shadow-[var(--elevation-3)] rounded-[var(--radius-lg)]',
        'duration-200',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          'absolute end-4 top-4 rounded-full p-1 text-on-surface-variant opacity-70 transition-opacity',
          'hover:opacity-100 state-layer',
