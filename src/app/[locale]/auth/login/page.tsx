...
export default function LoginPage() {
 ...
 const sanitizeRedirectPath = (redirectParam: string | null): string => {
 if (!redirectParam) return '';
 if (redirectParam.startsWith('http://') || redirectParam.startsWith('https://')) return '';
 ...
 className="w-full px-12 py-3.5 bg-surface-container border border-outline-variant rounded-xl text-on-surface placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all"
 required
 />
 <button
 type="button"
