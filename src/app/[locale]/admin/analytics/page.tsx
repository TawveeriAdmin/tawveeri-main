...
export default async function AdminAnalyticsPage({
 ...
 <CardContent>
 <p className="text-headline-md">{stats?.totalUsers || 0}</p>
 </CardContent>
 </Card>
 <Card>
 <CardHeader className="pb-2">
 ...
 <CardContent>
 <p className="text-headline-md">{stats?.totalProducts || 0}</p>
 </CardContent>
 </Card>
 <Card>
 <CardHeader className="pb-2">
 ...
 <CardContent>
 <p className="text-headline-md">{stats?.totalStores || 0}</p>
 </CardContent>
 </Card>
 <Card>
 <CardHeader className="pb-2">
 ...
 <CardContent>
 <p className="text-headline-md">{stats?.totalTransactions || 0}</p>
 </CardContent>
 </Card>
 <Card>
 <CardHeader className="pb-2">
