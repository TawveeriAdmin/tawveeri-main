      ...
      <Card>
        <CardHeader>
          <div className="flex items-start gap-6">
            {store.logo_url && (
              <div className="relative h-24 w-24 flex-shrink-0 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-800">
                <Image
                  src={store.logo_url}
                  alt={storeName}
                  fill
        ...
        <CardContent>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
            <div>
              ...
              <p className="mt-1 text-2xl font-bold">{store.total_products || 0}</p>
            </div>
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">
            ...
            <div>
              ...
              <p className="mt-1 text-2xl font-bold">{store.total_reviews || 0}</p>
            </div>
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">
                {isRTL ? 'معدل العمولة' : 'Commission Rate'}
              </p>
              <p className="mt-1 text-2xl font-bold">{store.commission_rate || 0}%</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      {analytics && (
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-2xl font-bold">{analytics.total_conversions.toLocaleString()}</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
