  ...
  return (
    <main style={{direction:'rtl',fontFamily:'Cairo,sans-serif',
      ...
      <div style={{maxWidth:'800px',margin:'0 auto'}}>
        ...
        <p style={{fontSize:'16px',color:'#7A9E92',lineHeight:'1.9',marginBottom:'32px'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:'12px',
          background:'#162019',border:'1px solid rgba(85,178,149,0.15)',
          borderRadius:'12px',padding:'24px',marginBottom:'40px',textAlign:'center'}}>
          {[['85K+','منتج'],['8','متجر'],['يومي','تحديث'],['مجاني','للمستخدم']].map(([n,l]) => (
            <div key={l}>
              <div style={{fontSize:'24px',fontWeight:'900',color:'#55B295'}}>{n}</div>
              <div style={{fontSize:'12px',color:'#7A9E92',marginTop:'4px'}}>{l}</div>
            </div>
          ))}
        </div>
