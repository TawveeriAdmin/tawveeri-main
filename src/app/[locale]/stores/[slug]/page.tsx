      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
          ...
          <CardContent className="p-6">
            <div className="flex flex-col lg:flex-row gap-6 items-start lg:items-center">
              <div className="flex items-center gap-4">
                <div className="relative w-24 h-24 rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700">
                  <img
                    src={
                      store.logo_url ||
                ...
                <div>
                  ...
                  <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">{storeName}</h1>
                  {description && (
                    <p className="text-gray-600 dark:text-gray-400 max-w-2xl whitespace-pre-line">{description}</p>
                  )}
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-3xl font-bold text-gray-900 dark:text-white">{store.total_products || 0}</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">{t('store.activeProducts')}</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">{t('store.statusDescription')}</p>
            </CardContent>
          </Card>
        </div>
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('store.products')}</h2>
              <p className="text-gray-600 dark:text-gray-400">{t('store.productsSubtitle')}</p>
            </div>
            <Badge variant="outline" className="text-sm">
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('store.reviews')}</h2>
              <p className="text-gray-600 dark:text-gray-400">{t('store.reviewsSubtitle')}</p>
            </div>
