...
export default function DashboardPage() {
 ...
 {isGuest && (
 <div className="mt-4 p-4 bg-primary-container border border-primary rounded-lg">
 <p className="text-on-primary-container mb-3">
 ...
 <span className="rounded-full p-2 bg-primary-container text-primary">
 ...
 <div key={index} className="flex items-start gap-3 text-sm text-on-surface-variant">
 ...
 <div className="w-full h-40 rounded-lg bg-surface-container-highest flex items-center justify-center text-sm text-on-surface-variant">
 {t('dashboard.noImage')}
 </div>
 )}
 ...
 <div className="w-full h-36 rounded-lg bg-surface-container-highest flex items-center justify-center text-sm text-on-surface-variant">
 {t('dashboard.noImage')}
 </div>
 )}
 <div className="flex items-center justify-between text-sm">
 ...
 <Card key={`recent-${product.id}`} className="min-w-[260px] flex-shrink-0 transition-shadow">
 <CardContent className="p-4 space-y-2">
 <Link href={`/${locale}/products/${product.slug}`} className="block text-label-lg text-on-surface line-clamp-2">
 {locale === 'ar' ? product.name_ar : product.name_en}
 </Link>
 {product.image_urls?.[0] ? (
 <img
 ...
 <div className="w-full h-32 rounded-lg bg-surface-container-highest flex items-center justify-center text-body-sm text-on-surface-variant">
 {t('dashboard.noImage')}
 </div>
 )}
 ...
 className="block p-2 rounded-lg hover:bg-surface-container-highest transition-colors"
 >
 <div className="flex items-center justify-between">
 ...
 href={`/${locale}/products/${product.slug}`}
 className="flex items-center justify-between p-2 rounded-lg hover:bg-surface-container-highest transition-colors"
 >
 <span className="text-label-lg text-on-surface line-clamp-1">
 {locale === 'ar' ? product.name_ar : product.name_en}
 </span>
 <ArrowRight className="w-4 h-4 text-outline" />
 </Link>
 ...
 className="block p-3 rounded-lg border border-outline-variant hover:bg-surface-container-highest transition-colors"
 >
 <div className="flex items-start justify-between">
 <div className="flex-1">
 <p className="text-label-lg text-on-surface line-clamp-1">
 {productName}
 </p>
 ...
 : 'border-primary bg-primary-container hover:bg-primary-container'
 }`}
 >
 ...
 <ArrowRight className="w-4 h-4 text-outline flex-shrink-0 mt-2" />
 </div>
 </Link>
 );
 })}
