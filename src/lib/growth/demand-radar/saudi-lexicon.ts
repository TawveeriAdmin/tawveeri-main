 ...
 *  in the same change.
 *
 *  Phase 2 (founder decision, same day, after the first post-narrowing cycle
 *  returned only 1 real opportunity): every category gains "ودي X"/"بشتري X"
 *  — Gulf-dialect direct-need verb variants already validated as intent
 *  markers (INTENT_MARKERS below) but never previously in a retrieval query,
 *  so X never returned posts using them. mobile/laptop additionally gain
 *  brand-first phrasing (ابي ايفون / ابي MacBook) — retrievable today because
 *  a mostly-Arabic sentence with an embedded Latin brand token still
 *  classifies lang:ar (verified against docs.x.com); NOT extended to other
 *  categories, where brand-first phrasing is less naturally how a purchase
 *  need gets tweeted. True English-only tweets are a separate, NOT-included
 *  gap — see the English-capture note below CATEGORY_LEXICONS. */
export const CATEGORY_LEXICONS: CategoryLexicon[] = [
  {
    category: 'mobile',
    nameAr: 'جوالات',
    xQuery:
      '("ابي جوال" OR "أبي جوال" OR "ابغى جوال" OR "أبغى جوال" OR "احتاج جوال" OR "أحتاج جوال" OR "جوالي خرب وابي بديل" OR "بدور على جوال" OR "ودي جوال" OR "بشتري جوال" OR "ابي ايفون" OR "أبي ايفون" OR "ابي iPhone" OR "ابغى جالكسي" OR "أبغى جالكسي")',
  ...
  },
  {
    ...
    nameAr: 'لابتوبات',
    xQuery:
      '("ابي لابتوب" OR "أبي لابتوب" OR "ابي لاب توب" OR "أبي لاب توب" OR "ابغى لابتوب" OR "أبغى لابتوب" OR "احتاج لابتوب" OR "أحتاج لابتوب" OR "بدور على لابتوب" OR "ودي لابتوب" OR "بشتري لابتوب" OR "ابي ماك بوك" OR "أبي ماك بوك" OR "ابي MacBook")',
  ...
  },
  {
    ...
    nameAr: 'تلفزيونات',
    xQuery:
      '("ابي تلفزيون" OR "أبي تلفزيون" OR "ابي شاشة" OR "أبي شاشة" OR "ابغى شاشة" OR "أبغى شاشة" OR "احتاج تلفزيون" OR "أحتاج تلفزيون" OR "بدور على شاشة" OR "ودي تلفزيون" OR "بشتري تلفزيون")',
  ...
  },
  {
    ...
    nameAr: 'مكيفات',
    xQuery:
      '("ابي مكيف" OR "أبي مكيف" OR "ابغى مكيف" OR "أبغى مكيف" OR "احتاج مكيف" OR "أحتاج مكيف" OR "مكيفي خرب وابي بديل" OR "بدور على مكيف" OR "ودي مكيف" OR "بشتري مكيف")',
  ...
  },
  {
    ...
    nameAr: 'ثلاجات',
    xQuery:
      '("ابي ثلاجة" OR "أبي ثلاجة" OR "ابغى ثلاجة" OR "أبغى ثلاجة" OR "احتاج ثلاجة" OR "أحتاج ثلاجة" OR "ثلاجتي خربت وابي بديل" OR "بدور على ثلاجة" OR "ودي ثلاجة" OR "بشتري ثلاجة")',
  ...
  },
  {
    ...
    nameAr: 'غسالات',
    xQuery:
      '("ابي غسالة" OR "أبي غسالة" OR "ابغى غسالة" OR "أبغى غسالة" OR "احتاج غسالة" OR "أحتاج غسالة" OR "غسالتي خربت وابي بديل" OR "بدور على غسالة" OR "ودي غسالة" OR "بشتري غسالة")',
  ...
  },
  {
    ...
    nameAr: 'أجهزة لوحية',
    xQuery:
      '("ابي ايباد" OR "أبي ايباد" OR "ابي آيباد" OR "ابغى ايباد" OR "أبغى ايباد" OR "ابي تابلت" OR "أبي تابلت" OR "احتاج تابلت" OR "أحتاج تابلت" OR "ودي ايباد" OR "بشتري ايباد")',
  ...
  },
  {
    ...
    xQuery:
      '("ابي شاشة كمبيوتر" OR "أبي شاشة كمبيوتر" OR "ابي مونيتر" OR "أبي مونيتر" OR "ابغى شاشة قيمنق" OR "احتاج شاشة كمبيوتر" OR "ودي شاشة كمبيوتر" OR "بشتري مونيتر")',
  ...
  },
  {
    ...
    xQuery:
      '("ابي سماعة" OR "أبي سماعة" OR "ابغى سماعة" OR "أبغى سماعة" OR "احتاج سماعة" OR "أحتاج سماعة" OR "ابي سماعات" OR "أبي سماعات" OR "ودي سماعة" OR "بشتري سماعة")',
  ...
  },
  {
    ...
    nameAr: 'أفران',
    xQuery:
      '("ابي فرن" OR "أبي فرن" OR "ابغى فرن" OR "أبغى فرن" OR "احتاج فرن" OR "أحتاج فرن" OR "فرني خرب وابي بديل" OR "ودي فرن" OR "بشتري فرن")',
    keywords: ['فرن', 'أفران', 'افران', 'فرن كهربائي', 'فرن غاز', 'فرن بلت ان', 'oven'],
  },
];

// FILED, NOT BUILT (founder decision 2026-08-26): true English-only purchase
// tweets ("need a new laptop under 3000 SAR") are excluded by TWO independent
// gates today — adapters.ts appends `lang:ar` to every query, and
// heuristics.ts's hasArabic() prefilter drops anything with no Arabic script
// before classification even runs. Capturing them isn't a lexicon change: it
// needs a parallel lang:en (or no-lang) query batch, dropping hasArabic() for
// that batch, and English-capable KSA-relevance markers (current KSA_MARKERS
// is Arabic-only). Doubles the X query count per cycle. Especially relevant
// for mobile/laptop given the Latin brand-first terms just added above —
// revisit as its own decision, not bundled into this pass.
